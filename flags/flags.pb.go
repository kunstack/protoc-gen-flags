...
func (x *FieldFlags) Reset() {
	*x = FieldFlags{}
	mi := &file_flags_flags_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FieldFlags) Descriptor() ([]byte, []int) {
	return file_flags_flags_proto_rawDescGZIP(), []int{40}
}
...
const file_flags_flags_proto_rawDesc = "" +
	"\n" +
	"\x11flags/flags.proto\x12\x05flags\x1a google/protobuf/descriptor.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\x02\n" +
	"\tBytesFlag\x12\x1a\n" +
...
var file_flags_flags_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
func file_flags_flags_proto_init() {
	...
	file_flags_flags_proto_msgTypes[2].OneofWrappers = []any{}
	...
	file_flags_flags_proto_msgTypes[37].OneofWrappers = []any{}
	...
	file_flags_flags_proto_msgTypes[40].OneofWrappers = []any{
